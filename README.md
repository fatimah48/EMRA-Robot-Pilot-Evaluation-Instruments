...
This part is completed only when a Talk session is used. It is skipped when the child uses the educational activities only.

### Conversational Behaviour During the Talk Session

| Behaviour | Rating / Frequency | Notes |
|---|---|---|
| How often the child gave any clear response after EMRA spoke. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Child spoke to EMRA without being asked (unprompted initiation). | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
...
| Measure | 1 | 2 | 3 | 4 | 5 |
|---|---|---|---|---|---|
| **Engagement** | No participation | Adult-directed only | Some participation | Participated most of session | Highly engaged |
| **Attention** | Almost none | Brief | About half | Most of session | Sustained throughout |
...
| **Emotional appropriateness** | Clearly mismatched | Often mismatched | Mixed / unclear | Mostly appropriate | Clearly appropriate |

> Emotional appropriateness refers to the spoken reply and the face-screen expression considered together.

## Part 5: Event Checklist

| Event | Frequency | Notes |
|---|---|---|
| Child reacted negatively to robot sound. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Child reacted negatively to robot movement. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Child showed distress. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Child moved away from or refused EMRA. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| EMRA did not respond or gave an unrelated reply. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| EMRA’s facial expression did not match the child’s observed state. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Noticeable response delay or technical failure. | ○ Never<br>○ Rarely<br>○ Sometimes<br>○ Often |  |
| Session stopped early. | ○ No<br>○ Child-related<br>○ Technical |  |
...
The Child Preference Form is completed immediately after each session with educator assistance.
...
<strong>Point to the face that shows what you think.</strong>
...
<table>
  ...
  <tbody>
    <tr bgcolor="#ffffff">
      <td bgcolor="#ffffff">
        <strong>Q3. Would you like to play or talk with EMRA again?</strong>
      </td>
...
| Number of EMRA sessions you ran or observed |  |
...
| Question | Response |
|---|---|
| **What worked best about EMRA?** | <br><br><br><br> |
| **What was the main problem or difficulty when using EMRA?** | <br><br><br><br> |
| **What would you change or improve before EMRA is used regularly?** | <br><br><br><br> |
...
## Main Automatically Logged Fields
